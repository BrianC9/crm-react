...
function ClientRow({client}) {
  ...
  return (
    <tr className="border-b font-medium text-lg">
      ...
      <button 
        type="button" 
        class="text-white bg-gradient-to-r from-red-400 via-red-500 to-red-600 hover:bg-gradient-to-br hover:ring-4 hover:outline-none hover:ring-red-300 dark:hover:ring-red-800 font-medium rounded-lg text-sm px-5 py-2.5 text-center ">
        Delete
      </button>
